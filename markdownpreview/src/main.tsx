 ...
 */
export class Markdownpreview extends PrimedComponent implements IComponentHTMLView {
 ...
 */
export const MarkdownpreviewInstantiationFactory = new PrimedComponentFactory(
    Markdownpreview,
    [],
);
